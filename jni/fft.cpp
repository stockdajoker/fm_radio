...
static JNINativeMethod gMethods[] = {
    {"DoFFT", "([DI)V", (void *)Java_com_radio_helloradio_HelloRadio_DoFFT},
};
...
jint JNI_OnLoad(JavaVM* vm, void* reserved)
{
    ...
    jniRegisterNativeMethods(env, "com/radio/helloradio/HelloRadio", gMethods, 1);
    return JNI_VERSION_1_4;
}

void Java_com_radio_helloradio_HelloRadio_DoFFT(
            JNIEnv* env,
	        jobject thiz,
            jdoubleArray data,
            jint size) {
